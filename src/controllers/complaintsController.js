...
exports.fileComplaint = async (req, res) => {
    try {
        ...
        const result = await complaintsService.createComplaint(entity, description, correlationId);
...
exports.updateComplaintStatus = async (req, res) => {
    try {        
        ...
        const result = await complaintsService.updateComplaintStatus(id_complaint, complaint_status, username, correlationId);
